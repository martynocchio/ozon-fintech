...
func (m *MockRepository) CreateShortURL(arg0 context.Context, arg1 *ozon_fintech.Link) (string, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) GetBaseURL(arg0 context.Context, arg1 *ozon_fintech.Link) (string, error) {
	m.ctrl.T.Helper()
...
func (mr *MockRepositoryMockRecorder) GetBaseURL(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetBaseURL", reflect.TypeOf((*MockRepository)(nil).GetBaseURL), arg0, arg1)
}
